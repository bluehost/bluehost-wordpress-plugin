...
function mm_add_button( $icons ) {
	$img = plugins_url( "mojo-marketplace/" ) . "img/mojo-icon-22.png";
	$id = 'mm_sg_container';
	$title = '';
...
<div id="mm_sg_container" style="display:none;">
	<div class="mm_sg_header">
		<img style="margin: 0 auto;" src="<?php echo plugins_url( "mojo-marketplace/" ) . "img/mojo-sg-header.png"; ?>" />
...
jQuery( document ).ready( function() {
	function mm_build_shortcode() {
		...
		return "[mojoitem platform='" + platform + "' type='" + type + "' item='" + item + "' quantity='" + quantity + "']";
	}
	...
	<article class="item">
		<div class="box">
			<div class="item-photo">
				<a target="_blank" class="screenshot" href="' . mm_build_link( $item->page_url, array( 'utm_medium' => 'plugin_shortcode', 'utm_content' => 'item_thumbnail' ) ) . '">
			...
			<div class="item-title">
				<h3 class="title">
					<a target="_blank" href="' . mm_build_link( $item->page_url, array( 'utm_medium' => 'plugin_shorcode', 'utm_content' => 'item_title_link' ) ) . '">' . $item->name . '</a>
				</h3>

				<h5 class="author">
					<a target="_blank" href="' . mm_build_link( $item->seller_url, array( 'utm_medium' => 'plugin_shortcode', 'utm_content' => 'item_seller_link' ) ) . '">' . $item->seller_name . '</a>
				</h5>
			</div>
