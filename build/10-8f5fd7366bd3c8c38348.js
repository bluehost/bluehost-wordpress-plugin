(window["webpackJsonp_bluehost_wordpress_plugin"] = window["webpackJsonp_bluehost_wordpress_plugin"] || []).push([[10],{
...
/***/ "./src/app/pages/marketplace/product-details/index.js":
/*!************************************************************!*\
  !*** ./src/app/pages/marketplace/product-details/index.js ***!
  \************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/app/pages/marketplace/product-details/style.scss");
...
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! change-case */ "./node_modules/change-case/change-case.js");
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(change_case__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony import */ var _app_hooks__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @app/hooks */ "./src/app/hooks/index.js");
...
function ProductDetails(_ref) {
  ...
  var _useMojoApi = Object(_app_hooks__WEBPACK_IMPORTED_MODULE_11__["useMojoApi"])('items', {
    id: id
  }),
      _useMojoApi2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useMojoApi, 1),
      _useMojoApi2$ = _useMojoApi2[0],
      done = _useMojoApi2$.done,
      isError = _useMojoApi2$.isError,
      isLoading = _useMojoApi2$.isLoading,
      payload = _useMojoApi2$.payload;
  ...
  var header = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Premium %s', 'bluehost-wordpress-plugin'), type);
  var breadcrumbText = header;
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    setItem(Object(_app_functions__WEBPACK_IMPORTED_MODULE_8__["get"])(['items', 0], payload));
  }, [payload]);
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (item) {
      setType(Object(change_case__WEBPACK_IMPORTED_MODULE_9__["ucFirst"])(item.type));
    }
  }, [item]);

  if (!done || isLoading) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_app_components_atoms__WEBPACK_IMPORTED_MODULE_3__["BWASpinner"], null);
  }

  if (isError) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_app_assets__WEBPACK_IMPORTED_MODULE_6__["ErrorStateImage"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Oops! Something went wrong.', 'bluehost-wordpress-plugin')), ";");
  }

  var buyUrl = item.buy_url,
      created = item.created,
      preview_url = item.images.preview_url,
      modified = item.modified,
      name = item.name,
      single_domain_license = item.prices.single_domain_license,
      sales_count = item.sales_count,
      description = item.description;
  var dateCreated = new Date(created);
  var dateUpdated = new Date(modified);
  var months = [Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('January', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('February', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('March', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('April', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('May', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('June', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('July', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('August', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('September', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('October', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('November', 'bluehost-wordpress-plugin'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('December', 'bluehost-wordpress-plugin')];
  var price = parseInt(single_domain_license, 10);
  var sales = parseInt(sales_count, 10).toLocaleString({
    useGrouping: true
  });
  return redirect ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_app_components_atoms__WEBPACK_IMPORTED_MODULE_3__["BWARedirect"], {
  ...
  }) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_app_components_templates__WEBPACK_IMPORTED_MODULE_5__["BWACommonTemplate"], {
    type: "marketplace",
    className: "page-product"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("header", {
    className: "page-product__header"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("h1", null, header)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__breadcrumbs"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("button", {
    className: "page-product__breadcrumbs-root",
    onClick: function onClick() {
      return window.history.back();
    }
  }, breadcrumbText), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", null, " / "), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", null, Object(_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_7__["decodeEntities"])(name))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__main"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__main"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__content"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("h2", {
    className: "page-product__title"
  }, Object(_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_7__["decodeEntities"])(name)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__image"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("img", {
    src: preview_url,
    alt: name
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__description",
    dangerouslySetInnerHTML: {
      __html: description
    }
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__sidebar"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__pricing-panel"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__pricing-panel-price"
  }, "$", price), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__pricing-panel-currency"
  }, "USD"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_app_components_atoms__WEBPACK_IMPORTED_MODULE_3__["BWAButton"], {
    className: "page-product__pricing-panel-call-to-action",
    href: buyUrl,
    target: "_blank",
    isPrimary: true
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Buy Now', 'bluehost-wordpress-plugin')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__pricing-panel-terms"
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('One Time Fee', 'bluehost-wordpress-plugin'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__info-panel"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("h3", {
    className: "page-product__info-panel-title"
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Item Information', 'bluehost-wordpress-plugin')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__info-panel-created"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("strong", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Created: ', 'bluehost-wordpress-plugin')), "".concat(months[dateCreated.getMonth()], " ").concat(dateCreated.getDate(), ", ").concat(dateCreated.getFullYear())), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__info-panel-updated"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("strong", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Updated: ', 'bluehost-wordpress-plugin')), "".concat(months[dateUpdated.getMonth()], " ").concat(dateUpdated.getDate(), ", ").concat(dateUpdated.getFullYear())), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "page-product__info-panel-sales"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("strong", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Sales: ', 'bluehost-wordpress-plugin')), sales))))));
}

/***/ }),

/***/ "./src/app/pages/marketplace/product-details/style.scss":
/*!**************************************************************!*\
  !*** ./src/app/pages/marketplace/product-details/style.scss ***!
  \**************************************************************/
/*! no static exports found */
...
//# sourceMappingURL=10-8f5fd7366bd3c8c38348.js.map