...
$request_url .= '?' . $query;
$plugins = mm_api_cache( $request_url );
?>
<div class="wrap">
	...
	foreach ( $items as $item ) {
		...
		<div class="plugin" tabindex="0">
			<div class="plugin-screenshot">
				<a target="_blank" href="<?php echo mm_build_link( $item->page_url, array( 'utm_medium' => 'plugin_admin', 'utm_content' => 'item_plugins_image_click' ) ); ?>">
			...
			<div class="mojo-plugin-actions">
				<form class="buy_now" method="POST" target="_blank" action="<?php echo mm_build_link( "https://www.mojomarketplace.com/cart", array( 'utm_medium' => 'plugin_admin', 'utm_content' => 'item_plugins_buy_now_button' ) ); ?>" class="buy_now <?php echo 'item_plugins_buy_now_' . mm_title_to_slug( $item->name ) ;?>">
				...
				<a target="_blank" href="<?php echo mm_build_link( $item->page_url, array( 'utm_medium' => 'plugin_admin', 'utm_content' => 'item_plugins_details_button' ) ); ?>" class="button button-secondary">Details</a>
