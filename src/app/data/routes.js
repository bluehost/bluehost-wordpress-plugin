...
export const routes = [
	...
	},
	{
		...
		subRoutes: [
			...
			NewfoldRuntime.hasCapability( 'hasYithExtended' ) || (NewfoldRuntime.hasCapability('canAccessGlobalCTB') && (NewfoldRuntime.sdk.ecommerce.brand_settings.brand === "bluehost"))
			? {
