...
const WonderBlocksSettings = () => {
	...
	const getWonderBlocksNoticeText = () => {
		return wonderBlocks
			? __(
					'Create content to see Wonder Blocks in action.',
					'wp-plugin-bluehost'
			  )
			: __(
	...
	return (
		<div className="nfd-flex nfd-flex-col nfd-gap-6">
			<ToggleField
				...
				label="Wonder Blocks"
				description={ __(
					'Wonder Blocks give you patterns and templates to help create site content faster and better using AI to tailor content to your site.',
					'wp-plugin-bluehost'
				) }
