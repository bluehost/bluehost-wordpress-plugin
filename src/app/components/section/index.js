	...
	return (
		<div
			className={ classNames(
				'wppbh-app-section-container nfd-bg-white nfd-w-full nfd-rounded-lg nfd-shadow',
				className
			) }
		>
			{ children }
...
export const SectionSettings = ( {
	...
	return (
		<section
			className={ classNames(
				'nfd-grid xl:nfd-grid-cols-3 xl:nfd-gap-12',
				className
			) }
		>
			<div className="nfd-col-span-1">
				<div className="nfd-max-w-screen-sm">
					...
					{ description && (
						<div className="nfd-mt-2">{ description }</div>
					) }
				</div>
			</div>
			...
			<fieldset className="nfd-min-w-0 nfd-mt-8 xl:nfd-mt-0 xl:nfd-col-span-2">
				...
				<div className="st-space-y-8">{ children }</div>
			</fieldset>
		</section>
	);
};
